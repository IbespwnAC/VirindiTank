...
internal class fs : IDisposable
{
    ...
    {
        PluginCore.cq.l.i.Add(this.c[A_1].Id);
        PluginCore.cq.l.d();
        er.a();
    }
    ...
    private void b()
    {
        ...
        if (string.IsNullOrEmpty(str))
        {
            ...
            {
                if (!PluginCore.cq.l.i.Contains(spell.Id))
                {
        ...
        else
        {
            foreach (MySpell spell2 in this.b)
            {
                ...
                if (friendlyName.ToLowerInvariant().Contains(str) && !PluginCore.cq.l.i.Contains(spell2.Id))
                {
